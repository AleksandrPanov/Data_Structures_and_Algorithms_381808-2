1) В Containers.h описаны прототипы функций классов Container и MyArray. В файле Source.cpp объявлена функция main() тестирующая функциональность класса MyArray.
